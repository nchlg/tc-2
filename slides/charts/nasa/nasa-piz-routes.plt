...
GNUTERM = "wxt"
x = 0.0
## Last datafile plotted: "nasa-piz-routes.dat"
...
set output "nasa-piz-routes-cspline.eps"
plot "nasa-piz-routes.dat" using 2:xtic(everyNth(0,1,spacing)) title "SBR" smooth cspline ls 1, "" using 3:xtic(everyNth(0,1,spacing)) title "SBR-SZA" smooth cspline ls 2

set terminal postscript eps enhanced color font "Helvetica, 24"
set output "nasa-piz-routes-bezier.eps"
plot "nasa-piz-routes.dat" using 2:xtic(everyNth(0,1,spacing)) title "SBR" smooth bezier ls 1, "" using 3:xtic(everyNth(0,1,spacing)) title "SBR-SZA" smooth bezier ls 2
