...
set output "nasa-path-cost-comparison.png"
plot "nasa-path-cost-comparison.dat" using 2:xtic(1) title "PRESENT-80" ls 1 fs pattern 1,\
...
set output "nasa-path-cost-comparison.eps"
plot "nasa-path-cost-comparison.dat" using 2:xtic(1) title "PRESENT-80" ls 1 fs pattern 1,\
 "" u 3:xtic(1) title "AES-128" ls 2 fs pattern 2,\
 "" u 4:xtic(1) title "HIGHT" ls 3 fs pattern 3,\
 "" u 5:xtic(1) title "mCrypton" ls 4 fs pattern 4,\
