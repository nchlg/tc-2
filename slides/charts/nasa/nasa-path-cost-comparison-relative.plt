...
set title "NASA NAS Average Latency Variation Relative to Base-NoC"
set auto
...
set output "nasa-path-cost-comparison-relative.eps"
plot "nasa-path-cost-comparison-relative.dat" using 2:xtic(1) title "PRESENT-80" ls 1 fs pattern 1,\
