	...
	\begin{document}
		...
		\includepdf[pages={1},scale=1.0,offset=0 -2cm,pagecommand=\chapter{\label{apnd:tcle}Termo de Consentimento Livre e Esclarecido}]{./pdf/tcle.pdf}
		\includepdf[pages={2-},scale=1.0]{./pdf/tcle.pdf}
