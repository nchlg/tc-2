...
set title "SYNTH1 Average Latency Variation Relative to Base-NoC"
set auto
...
set output "synth1-path-cost-comparison-relative.eps"
plot "synth1-path-cost-comparison-relative.dat" using 2:xtic(1) title "PRESENT-80" ls 1 fs pattern 1,\
 ...
 "" u 7:xtic(1) title "DESXL" ls 6 fs patter 6
