...
set title "SYNTH2 Average Latency Variation Relative to Base-NoC"
#set auto
...
set output "synth2-path-cost-comparison-relative.eps"
plot "synth2-path-cost-comparison-relative.dat" using 2:xtic(1) title "PRESENT-80" ls 1 fs pattern 1,\
