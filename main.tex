...
\begin{table}[h]
	\centering
	\caption[Dados do Avaliador \#1]{\label{apnd:form-1-infos}Dados do avaliador \#1}
...
\begin{table}[h]
	\centering
	\caption[Tarefas do Avaliador \#1]{\label{apnd:form-1-infos}Desempenho do avaliador \#1 durante as tarefas}
	\resizebox{\textwidth}{!}{\begin{tabular}{|l|l|l|l|l|l|l|}
		\cline{1-7}
		Tarefas & \multicolumn{2}{|l|}{O caminho que fizeste na cabeça condiz com o caminho apresentado pelo aplicativo?} & Duração & \multicolumn{2}{|l|}{Achas que conseguiria realizar a tarefa em menos tempo?} & Observação \\ \cline{1-7}
		1. Selecionar um restaurante qualquer & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		2. Favoritar um restaurante			  & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		3. Desfavoritar um restaurante 		  & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		4. Buscar um restaurante através do sistema de busca & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		5. Acessar o cardápio do restaurante Espaço 32		 & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		6. Filtrar o cardápio por comidas vegetarianas, sem lactose e ordenar as informações por ordem de acesso & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		7. Verificar os ingredientes de uma "Torrada Simples" & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		8. Verificar a quantidade do produto "Pão de Queijo" disponível no restaurante & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
		9. Voltar à tela principal após verificar as informações adicionais de um produto do cardápio & ( ) Sim & ( ) Não & & ( ) Sim & ( ) Não & \\ \cline{1-7}
	\end{tabular}}
\end{table}
