	...
	\resizebox{0.8\textwidth}{!}{
		\begin{tabu}{|L{25em}|c|c|c|c|c|c|}
			\cline{1-7}
				...
				b. O aplicativo não exige o aprendizado intensivo ou leitura de vasta documentação para ser utilizado. & & & & & X & \\ \cline{1-7}
				c. As informações apresentadas são fáceis de entender. & & & & & X & \\ \cline{1-7}
...
\begin{table}
	...
	\resizebox{0.8\textwidth}{!}{
		\begin{tabu}{|C{1.5em}|C{1.5em}|C{1.5em}|C{1.5em}|C{1.5em}|c|c|c|c|}
			...
			\textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} & \textbf{N/A} & \textbf{TOTAIS} & \textbf{QTD. VÁLIDA} & \textbf{MÉDIA} \\ \cline{1-9}
	...
	\begin{table}
		...
		\begin{table}[h]
			...
			\resizebox{\textwidth}{!}{\begin{tabu}{|C{3em}|L{6em}|L{6em}|C{5em}|L{6em}|L{6em}|L{10em}|}
					\cline{1-7}
					Tarefas & \multicolumn{2}{L{12em}|}{O caminho que fizeste na cabeça condiz com o caminho apresentado pelo aplicativo?} & Duração & \multicolumn{2}{L{12em}|}{Achas que conseguiria realizar a tarefa em menos tempo?} & Observação \\ \cline{1-7}
					[1] & (X) Sim & ( ) Não & 0:03 & ( ) Sim & (X) Não & Pergunta não estava muito clara\\ \cline{1-7}
					[2] & (X) Sim & ( ) Não & 0:06 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[3] & (X) Sim & ( ) Não & 0:05 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[4] & (X) Sim & ( ) Não & 0:05 & ( ) Sim & (X) Não & O usuário esperava que o sistema mostrasse todas as opções dos restaurantes a medida que ele fosse inserindo caracteres em sua pesquisa. O usuário também teve problemas com o teclado da versão Lollipop \\ \cline{1-7}
					[5] & (X) Sim & ( ) Não & 0:05 & ( ) Sim & (X) Não & \\ \cline{1-7}
	...
	\begin{table}
		...
		\begin{table}[h]
			...
			\resizebox{\textwidth}{!}{\begin{tabu}{|C{3em}|L{6em}|L{6em}|C{5em}|L{6em}|L{6em}|L{10em}|}
					\cline{1-7}
					Tarefas & \multicolumn{2}{L{12em}|}{O caminho que fizeste na cabeça condiz com o caminho apresentado pelo aplicativo?} & Duração & \multicolumn{2}{L{12em}|}{Achas que conseguiria realizar a tarefa em menos tempo?} & Observação \\ \cline{1-7}
					[1] & (X) Sim & ( ) Não & 0:02 & ( ) Sim & (X) Não & Pergunta não estava muito clara\\ \cline{1-7}
					[2] & (X) Sim & ( ) Não & 0:01 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[3] & (X) Sim & ( ) Não & 0:01 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[4] & (X) Sim & ( ) Não & 0:04 & (X) Sim & ( ) Não & Se a busca é por nome ou endereço, isso deveria estar explícito nas sugestões de busca \\ \cline{1-7}
					[5] & (X) Sim & ( ) Não & 0:04 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[6] & (X) Sim & ( ) Não & 0:11 & ( ) Sim & (X) Não & \emph O sistem poderia dar um {feedback} quando os filtros forem aplicados\\ \cline{1-7}
					[7] & (X) Sim & ( ) Não & 0:15 & ( ) Sim & (X) Não & \\ \cline{1-7}
					[8] & (X) Sim & ( ) Não & 0:09 & ( ) Sim & (X) Não & \\ \cline{1-7}
					%TODO: Arrumar esses acentos.......
					[9] & (X) Sim & ( ) Não & 0:06 & (X) Sim & ( ) Não & Sim, se tivesse um bot~ao para a p´agina inicial. Todavia, para o contexto do aplicativo, n~ao lhe parece necess´ario\\ \cline{1-7}
				\end{tabu}}
			\end{table}
