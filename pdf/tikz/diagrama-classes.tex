	...
	\begin{figure}
		...
		\begin{umlpackage}{cardapio virtual}
			...
			\begin{umlpackage}[x=0, y=-2.5]{auxiliaries}
				\umlemptyclass{FilterInterface}
				\umlemptyclass[right=1cm of FilterInterface]{Filters}
				\umlemptyclass[below=1cm of FilterInterface]{Node}
				\umlemptyclass[right=1cm of Node]{SimpleDividerItemDecotarion}
				\umlemptyclass[below=1cm of Node]{Utilitarians}
				\umlemptyclass[right=1cm of Utilitarians]{RestrictionVerifier}
